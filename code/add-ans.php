...
include('inc/sidebar.php');
  ...
  if(isset($_POST['submit'])){
    ...
    $check_query="SELECT * FROM answers   WHERE Content_Ans ='$content'";
...
if(empty($content))
 ...
 $error1 =" Content Already Exist ";    
         ...
         $insert_query = "INSERT INTO `answers` (`Content_Ans`,`id_que`) VALUES ('$content','$que')";
...
?>
                ...
                <div class="form-group">
                    <label for="username">Answer Content</label>
        ...
        <select  class="custom-select mr-sm-2" name="que">
<?php
        $res=mysqli_query($connection,"SELECT * FROM questions");
        while($row=mysqli_fetch_array($res))
{
?>
         <option value="<?php echo $row["ID_Que"]; ?>"><?php echo $row["Content_Que"]; ?></option>
